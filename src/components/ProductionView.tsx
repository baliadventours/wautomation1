...
SIMULATE_TYPING_PRESENCE=true`;
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      {/* Webdock VPS Live Deployment Target Card */}
      <div className="bg-gradient-to-br from-neutral-900 via-neutral-900 to-neutral-950 text-white rounded-2xl p-6 border border-neutral-800 shadow-sm relative overflow-hidden">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-neutral-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base font-bold text-white tracking-tight">Webdock VPS Live Target</h2>
                <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-950 text-emerald-300 border border-emerald-700/50 flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
                  Ready to Deploy
                </span>
              </div>
              <p className="text-xs text-neutral-400 mt-0.5">
                Connected to <span className="text-neutral-200 font-mono">wautomation1.vps.webdock.cloud</span> on Ubuntu Noble 24.04
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <a
              href="https://wautomation1.vps.webdock.cloud"
              target="_blank"
              rel="noreferrer"
              className="px-3 py-1.5 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-neutral-200 hover:text-white border border-neutral-700 text-xs font-semibold transition flex items-center gap-1.5"
            >
            ...
            <a
              href="https://github.com/baliadventours/wautomation1"
              target="_blank"
              rel="noreferrer"
              className="px-3 py-1.5 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-neutral-200 hover:text-white border border-neutral-700 text-xs font-semibold transition flex items-center gap-1.5"
            >
        ...
        {/* Server Specification Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 py-4 border-b border-neutral-800/80 text-xs">
          <div className="p-3 bg-neutral-900/60 rounded-xl border border-neutral-800">
            <span className="text-neutral-400 text-[10px] uppercase font-bold tracking-wider block">Domain / Host</span>
            <span className="font-mono text-emerald-400 text-xs font-medium truncate block mt-0.5">
              wautomation1.vps.webdock.cloud
            </span>
          </div>
          <div className="p-3 bg-neutral-900/60 rounded-xl border border-neutral-800">
            <span className="text-neutral-400 text-[10px] uppercase font-bold tracking-wider block">Public IPv4</span>
            <span className="font-mono text-white text-xs font-medium block mt-0.5">
              193.181.218.146
            </span>
          </div>
          <div className="p-3 bg-neutral-900/60 rounded-xl border border-neutral-800">
            <span className="text-neutral-400 text-[10px] uppercase font-bold tracking-wider block">Target OS</span>
            <span className="text-white text-xs font-medium block mt-0.5">
              Ubuntu Noble 24.04 LTS
            </span>
          </div>
          <div className="p-3 bg-neutral-900/60 rounded-xl border border-neutral-800">
            <span className="text-neutral-400 text-[10px] uppercase font-bold tracking-wider block">Stack Engine</span>
            <span className="text-white text-xs font-medium block mt-0.5">
        ...
        {/* 1-Line Execution Command */}
        <div className="pt-4 space-y-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 text-xs text-neutral-300 font-medium">
              <Terminal className="w-3.5 h-3.5 text-emerald-400" />
              <span>Copy and run in your Webdock Web SSH or Terminal:</span>
            </div>
            <span className="text-[11px] text-neutral-500">Root privileges required</span>
          </div>

          <div className="relative group">
            <div className="p-3.5 bg-black/80 rounded-xl border border-neutral-800 font-mono text-xs text-emerald-300 overflow-x-auto pr-24 select-all">
              curl -fsSL https://raw.githubusercontent.com/baliadventours/wautomation1/main/install-webdock.sh | sudo bash
            </div>
            <button
              onClick={() => handleCopy('curl -fsSL https://raw.githubusercontent.com/baliadventours/wautomation1/main/install-webdock.sh | sudo bash', 'webdock-curl')}
              className="absolute top-2.5 right-2.5 px-3 py-1.5 rounded-lg bg-neutral-800 hover:bg-neutral-700 text-white text-xs font-sans font-semibold transition cursor-pointer flex items-center gap-1.5 border border-neutral-700"
            >
              {copiedTab === 'webdock-curl' ? (
                <>
          ...
          <p className="text-[11px] text-neutral-400">
            This script automatically installs Docker Engine, pulls from <code className="text-neutral-300 font-mono">github.com/baliadventours/wautomation1</code>, initializes PostgreSQL 16 & Redis 7, starts the WhatsApp Multi-Device Gateway, and configures Let's Encrypt SSL on Nginx.
          </p>
        </div>
      </div>
